        ...
        <section className="py-24 relative overflow-hidden bg-white">
            ...
            <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <div className="mt-10">
                        <button
                            onClick={() => window.open('https://wa.me/5544999999999?text=Ol%C3%A1%2C+quero+evitar+problemas+com+vidros+na+minha+obra.+Pode+me+explicar+como+voc%C3%AAs+trabalham%3F', '_blank')}
