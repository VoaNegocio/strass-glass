        ...
        <section className="py-24 bg-strass-blue text-white relative">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <button
                        onClick={() => window.open('https://wa.me/5544999999999?text=Ol%C3%A1%2C+sou+profissional+do+setor+%28Engenheiro%2FArquiteto%29+e+gostaria+de+discutir+uma+parceria+ou+obra.', '_blank')}
